    ...
    return Column(
      ...
      children: [
        ...
        Row(
          children: [
            Text(
              '${widget.product['price']?.toStringAsFixed(2) ?? '0.00'} €/kg',
              style: TextStyle(
                fontSize: 28,
                fontWeight: FontWeight.bold,
                color: Colors.green[600],
            ...
            Container(
              ...
              child: Text(
                'Stock: ${widget.product['quantity'] ?? 0} kg',
                style: TextStyle(
                  fontSize: 12,
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  widget.product['producer'] ?? 'Producteur',
                  style: const TextStyle(
                    fontSize: 16,
                    fontWeight: FontWeight.w600,
                  ),
      ...
      children: [
        ...
        Row(
          children: [
            ...
            IconButton(
              onPressed: _quantity < (widget.product['quantity'] ?? 1)
                  ? () {
                      setState(() {
                        _quantity++;
                      });
              ...
              color: _quantity < (widget.product['quantity'] ?? 1) ? Colors.green[600] : Colors.grey[400],
            ),
            const Spacer(),
            Text(
              'Total: ${((widget.product['price'] ?? 0) * _quantity).toStringAsFixed(2)} €',
              style: TextStyle(
                fontSize: 18,
                fontWeight: FontWeight.bold,
                color: Colors.green[600],

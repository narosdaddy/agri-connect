...
import 'producteur_request_screen.dart';
...
class _ProfileScreenState extends State<ProfileScreen> with TickerProviderStateMixin {
  ...
  Widget _buildHeader() {
    ...
    final userRole = _userInfo['role'] ?? widget.role ?? 'Utilisateur';
  ...
  Widget _buildProfileInfo() {
    final userRole = _userInfo['role']?.toString().toUpperCase() ?? 'ACHETEUR';
    return Column(
      children: [
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildInfoField(
                icon: Icons.person,
                label: 'Nom complet',
                value: _userInfo['name'] ?? 'Non renseigné',
              ...
              _buildInfoField(
                icon: Icons.email,
                label: 'Email',
                value: _userInfo['email'] ?? 'Non renseigné',
          ...
          child: Column(
            ...
            children: [
              ...
              if (recentOrders.isEmpty)
                ...
                Column(
                  children: recentOrders.map((order) => _buildOrderItem(order)).toList(),
                ),
            ],
          ),
        );
  ...
  Widget _buildOrderItem(Map<String, dynamic> order) {
    ...
    final date = order['date'] ?? 'Date inconnue';
